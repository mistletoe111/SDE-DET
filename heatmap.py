...
def get_params():
    params = {
        'weight': "D:/桌面/新数据集-yolov8-yaml/SDE-DET\weights/best.pt",  # 训练出来的权重文件
        'cfg': "D:/桌面/新数据集-yolov8-yaml/SDE-DET/SDE-DET.yaml",  # 训练权重对应的yaml配置文件
        'device': 'cuda:0',
        'method': 'GradCAM',  # GradCAMPlusPlus, GradCAM, XGradCAM , 使用的热力图库文件不同的效果不一样可以多尝试
        'layer': 'model.model[18]',  # 想要检测的对应层
...
if __name__ == '__main__':
    ...
    model("D:/桌面/mmdetection-main (1)/data/val/images/83.jpg", "D:/桌面/heatmap")